...
**Why it rusts:** Water enters through the door drain holes, through cracks in the seam sealer between the inner and outer sill, and from road spray underneath. The box-section design means water sits inside the sill with no way to drain if the factory drain holes are clogged. Rust works from the inside out — by the time you see bubbling on the outside, the inner sill structure may already be compromised.
...
**Why it rusts:** Same mechanism as rear arches — stone chips and road spray. The front arches are actually less prone than the rears on E36s because the front fenders are bolt-on panels (easy to replace) and there's less trapped moisture. However, the inner splash guards often deteriorate, exposing the inner fender structure.
...
**Why it rusts:** Water enters through deteriorated trunk seal gaskets, cracked tail light gaskets, or blocked sunroof drains (on equipped models) that overflow into the trunk area. The trunk carpet traps moisture against the metal floor.

**What to look for:** Pull up the trunk carpet and spare tire cover. Look for damp carpet or standing water first — this tells you water is currently entering. Check the entire floor for bubbling, soft spots, or perforation. Pay special attention to the seams and the area directly below the tail lights.

**Repair difficulty:** Medium. Floor panel patches are straightforward but time-consuming due to the area involved. The trunk must be completely stripped. Seam sealer replacement is essential after any trunk floor repair.
...
**Why it rusts:** Water collects here by gravity. If the trunk floor has any leaks, the spare wheel well is where the water ends up. The spare tire sits on top of standing water, trapping it.

**What to look for:** Remove the spare tire and inspect the well. Look for standing water, surface rust, or perforation. Check the drain plug at the bottom of the well — if it's missing or corroded, water has no escape path.

**Repair difficulty:** Low-Medium. Small perforations can be patched. Large-scale damage may require welding in a new well section. Usually repaired alongside trunk floor work.
...
**Why it rusts:** Doors have drain holes at the bottom that allow water from the window channel to escape. These drain holes clog with dirt, leaves, and debris. When clogged, water sits inside the door and rusts from the inside out. The bottom of the door skin is also vulnerable to stone chips.
...
- [ ] ⚠️ Rear subframe mounting points (4 points)
- [ ] ⚠️ Sills — both sides, inner and outer (remove covers)
- [ ] ⚠️ Jack points — all four corners
- [ ] Rear wheel arches — inner lip and outer edge
- [ ] Front wheel arches — behind liner
- [ ] Battery tray — remove battery to inspect
- [ ] Trunk floor — pull carpet, check for moisture
- [ ] Spare wheel well — remove spare, check for water
- [ ] Door bottoms — all four, feel for perforation
- [ ] Windshield frame — lower corners (if glass out)
- [ ] Sunroof drains — if equipped, test flow
- [ ] Fuel filler pocket — check seams
- [ ] Rear shock towers — from inside trunk
- [ ] Front strut towers — top plates and surrounding metal
- [ ] Firewall seams — from underneath

**Tip:** Bring a flashlight, a small mirror (for seeing behind panels), a magnet (detects body filler — it won't stick to filler), and a flat-blade screwdriver (for gently probing suspect areas). If the screwdriver pushes through, you've found your answer.
