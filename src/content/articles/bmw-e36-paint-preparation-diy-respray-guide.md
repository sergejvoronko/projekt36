...
*   **Mechanical Stripping (DA Sander):** Start with an aggressive P80 grit disc on your DA sander. Keep the sander flat and constantly moving to avoid gouging the metal. Work panel by panel. The goal is to remove the colour and clear coat, down to the original, stable primer. If the factory primer is intact and not flaking, you can scuff it and prime over it. If you encounter any surface rust or failing primer, you must sand down to bare, shiny metal.
*   **Chemical Stripping:** Effective but incredibly messy and hazardous. Generally not recommended for a full-car strip in a home garage.
*   **Media Blasting:** The fastest and most thorough method, but requires outsourcing to a professional. If your budget allows, blasting the shell is an excellent way to get a perfectly clean start.
...
*   **Application:** Mix the filler according to the manufacturer's instructions. Apply thin, tight coats with a plastic spreader, pushing the filler into the surface to avoid air pockets. Build up the repair slightly higher than the surrounding panel.
*   **Shaping:** Once the filler is firm but not fully cured (about 15-20 minutes, like hard cheese), you can use a "cheese grater" file to quickly shape it and knock down high spots.
...
Now, for the secret to a perfectly straight car: the **guide coat**. This is a light, misted layer of a contrasting colour (a black aerosol or a dedicated dry powder like 3M Dry Guide Coat) applied over the entire surface of the cured primer.

Using a long sanding block (or a selection of blocks for different contours), begin block sanding the entire car with P320 grit sandpaper. The process is simple:
*   The guide coat will be sanded off the **high spots** first.
*   The guide coat will remain in the **low spots**.
...
1.  Finish block sanding the primer with **P400** or **P500** dry.
2.  Switch to wet sanding with **P600** or **P800** for the final pass. Wet sanding produces a finer, smoother finish and prevents the paper from clogging.

The car is now technically ready, but the final clean is paramount.
1.  Blow off all sanding dust from every crack and crevice with compressed air.
2.  Perform the two-towel degreasing method with panel wipe at least twice over the entire car. Change your towels frequently.
