...
The M52 is a workhorse, but after 25+ years and hundreds of thousands of kilometers, even the best straight-six needs a refresh. Whether you're chasing oil consumption, low compression, or just want to restore your E36's heart to factory-fresh condition, a full rebuild is the ultimate solution. This guide skips the basics and dives straight into the M52-specific details, part numbers, and procedures you need to get the job done right.

## TL;DR

| Aspect | Detail |
| :--- | :--- |
| **What:** | A complete teardown and rebuild of a BMW M52B25 or M52B28 engine. |
| **Why:** | To restore power, fix oil consumption/leaks, and ensure another 250,000 km of reliability. |
| **Cost:** | €1,500 - €3,500, depending heavily on machine shop work and part choices. |
| **Time:** | 40-60 hours of wrench time, plus 1-3 weeks for machine shop services. |
| **Difficulty:** | 5/5 - Requires precision tools, a clean workspace, and significant mechanical experience. |
...
*   **VANOS:** The infamous rattle at certain RPMs is a clear sign the seals and bearings are shot. The Beisan Systems kit is the industry-standard fix.
*   **CCV System:** The oil separator and its associated plastic hoses will be clogged with sludge, contributing to oil consumption.
*   **Oil Filter Housing Gasket (OFHG):** Guaranteed to be leaking. Check for oil pooled on the block beneath it.
...
1.  **Hot Tanking/Cleaning:** Removes all oil, sludge, and grime.
2.  **Decking:** Ensures a perfectly flat surface for the head gasket. A minimal skim is all that's needed unless the block is warped.
3.  **Honing:** Creates a fresh cross-hatch pattern on the cylinder walls for new piston rings to seat against.

Expect to pay €300 - €500 for these services. While it's there, have the shop measure your crankshaft journals and cylinder bores for wear against factory tolerances.

Here is your essential bottom-end parts list. Prices are approximate and based on quality OEM suppliers like Glyco, Kolbenschmidt, and Goetze.

| Part | Part Number (Example) | Avg. Cost (EUR) | Notes |
| :--- | :--- | :--- | :--- |
| Main Bearings (Std) | Glyco H023/7 STD | €80 | |
| Rod Bearings (Std) | Glyco 71-3683/6 STD | €50 | Consider S50B32/S52B32 bearings for higher performance. |
| Piston Rings (Std) | Goetze 08-111900-00 | €150 | Per set of 6. Ensure correct size for your bore. |
| Rear Main Seal | Elring 325.155 | €25 | Install with a proper driver to ensure it's seated evenly. |
...
| :--- | :--- | :--- |
| Main Bearing Caps | M10: 20 Nm + 50° | Use new bolts if specified. Clean threads thoroughly. |
| Connecting Rod Bolts | M6x43: 20 Nm + 70° | **Critical TTY bolts. Must be replaced.** BMW P/N 11241739728 |
...
| Part | Part Number (Example) | Avg. Cost (EUR) | Notes |
| :--- | :--- | :--- | :--- |
| Head Gasket Set | Victor Reinz 61-31445-20 | €120 | Includes head gasket, valve cover, intake/exhaust gaskets. |
| Head Bolts | Elring 115.110 | €40 | **Critical TTY bolts. Must be replaced.** |
| Valve Stem Seals | Included in gasket set | - | A special tool makes installation much easier. |
...
1.  Lay the head gasket on the block, ensuring correct orientation.
2.  Carefully lower the head onto the block.
3.  Install new, lightly oiled head bolts.
4.  Tighten in a spiral sequence starting from the center:
    *   **Stage 1:** 30 Nm
    *   **Stage 2:** +90°
    *   **Stage 3:** +90°
...
1.  Set the engine to Cylinder 1 TDC and insert the flywheel pin.
2.  Install camshafts with the lobes for Cylinder 1 pointing towards each other.
3.  Install the cam alignment blocks to lock the cams in place.
4.  Install the timing chain, guides, and tensioner. The chain guides are plastic and should always be replaced. A full timing kit from a brand like Febi Bilstein is a wise investment (~€150).
...
| Gasket / Seal | Part Number (Example) | Avg. Cost (EUR) | Notes |
| :--- | :--- | :--- | :--- |
| Timing Cover Gasket Set | Victor Reinz 15-31998-01 | €30 | Includes front main seal and profile gaskets. |
| Oil Filter Housing Gasket | Victor Reinz 71-34065-00 | €8 | A notorious leak point. |
| Valve Cover Gasket | Included in head set | - | Includes spark plug well seals. |
