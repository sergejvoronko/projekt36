...
**Chemical resistance:** Bird droppings, tree sap, insect acids, and road tar can etch unprotected clear coat. PPF provides a sacrificial barrier that absorbs these chemicals instead of the paint.

**Removability:** Quality PPF can be removed years later without damaging the underlying paint, provided the paint was properly cured before application and the film was professionally installed.
...
### Paint cure times before PPF application

| Paint type | Minimum cure time | Recommended cure time | Notes |
|---|---|---|---|
...
**Signs the paint isn't fully cured:**
- Solvent smell still detectable near the surface
- Paint feels soft or "tacky" when pressed firmly with a clean finger
- Paint surface shows fingerprints that don't wipe away easily
...
60–90 days is a long time to drive a freshly painted car unprotected. Here are your options:

**Option 1: Don't drive it until PPF is applied.** The safest approach. Keep the car garaged after paint until the cure period is complete, then apply PPF before the first drive.

**Option 2: Apply a temporary ceramic coating.** Some detailers recommend a sacrificial ceramic spray coating during the cure period. This provides basic protection against contaminants while allowing the paint to outgas. It's removed before PPF application.

**Option 3: Accept the risk.** Drive carefully, avoid gravel roads, and accept that minor stone chips may occur before PPF goes on. For some builds, this is the practical reality.
...
Maximum protection but maximum cost. Justifiable for investment-grade classics or concours-quality restorations. For a project build like ours, Track B offers the best value.
...
- Hood (large panel, needs precise alignment)
- Front bumper (complex curves around fog lights and grille)
- Fenders (compound curves)
...
Start with the headlights. They're small, flat, and if you mess up, the worst case is a €20 piece of wasted film. Practice the technique: spray the adhesive side with slip solution (soapy water), position the film, squeeze out the solution from center to edges, use a heat gun on curves, and tuck the edges.
...
Quality PPF lasts 5–10 years on a daily-driven car. On a project car that sees less mileage and spends more time garaged, it can last significantly longer. Modern films with anti-yellowing technology maintain clarity throughout their lifespan.
